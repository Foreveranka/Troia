...
const scenes = [
  {
    ...
    en: 'Open troia-extension.vercel.app. In Installation, click Download Troia ZIP.',
    tr: 'Troia sitesindeki Installation bölümüne git. Download Troia ZIP düğmesine tıkla.',
  },
  {
    ...
    en: 'Extract the ZIP. On Mac, double-click it. On Windows, right-click and select Extract All.',
    tr: 'ZIP dosyasını çıkar. Mac’te çift tıkla. Windows’ta sağ tıklayıp Tümünü Ayıkla’yı seç.',
  },
  {
    ...
    en: 'Type chrome://extensions in the address bar. Turn on Developer mode at the top right.',
    tr: 'Adres çubuğuna chrome://extensions yaz. Sağ üstten Geliştirici modu seçeneğini aç.',
  },
  {
    ...
    en: 'Click Load unpacked. Choose the extracted troia-testnet folder containing manifest.json, then Select Folder.',
    tr: 'Paketlenmemiş öğe yükle’ye tıkla. manifest.json içeren troia-testnet klasörünü seç ve onayla.',
  },
  {
    ...
    en: 'Troia is installed. Keep its folder. Open the demo store, add an item and select Pay with crypto, then Stellar.',
    tr: 'Troia kuruldu. Klasörü silme. Demo mağazada ürün ekle, Pay with crypto ve ardından Stellar seç.',
  },
];
